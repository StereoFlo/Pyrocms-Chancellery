...
<div id="section" style="width: 100%;">
    <div class="btnSave"><?= form_submit(['value' => lang('buttons:save'), 'id' => 'btnSubmit']); ?></div>
        ...
        <? if (!empty($ordered_items)) { ?>
            <? foreach ($ordered_items as $ordered_item) { ?>
                <? if ($item->id == $ordered_item->kanz_id) { ?>
                    ...
                    <div style="float: left; width: 15%"><?= form_input([
                            'onkeyup' => "check('input_" . $item->id . "', " . $item->quote . ");",
                            'id'      => "input_" . $item->id,
                            'name'    => $item->id,
                            'size'    => '5',
                            'value'   => $ordered_item->kolvo,
                        ]); ?></div>
    ...
    <? } ?>
    <div class="btnSave"><?= form_submit(['value' => lang('buttons:save'), 'id' => 'btnSubmit2']); ?></div>
</div>
<?= form_close(); ?>
