            ...
            <table border="0" class="table-list">
                ...
                <?php foreach ($contractors as $contractor): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo anchor('admin/chancellery/contractors/edit/' . $contractor->id,
                                lang('global:edit'), ['class' => 'button edit']); ?>
                            <?php echo anchor('admin/chancellery/contractors/delete/' . $contractor->id,
                                lang('global:delete'), ['class' => 'button delete']); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
