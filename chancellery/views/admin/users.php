				...
				<tbody>
					<?php foreach ($users as $user): ?>
						<tr>
							...
							<td class="actions">
								<?php echo anchor('admin/chancellery/users/edit/' . $user->id, lang('global:edit'), array('class'=>'button edit')); ?>
                                                                <?php echo anchor('admin/chancellery/users/delete/' . $user->id, lang('global:delete'), array('class'=>'button delete')); ?>
							</td>
							</tr>
					<?php endforeach; ?>
				</tbody>
