				...
				<tbody>
					<?php foreach ($items as $item): ?>
						<tr>
							...
							<td class="collapse"><a href="admin/chancellery/contractors/edit/<?= $contractor->id; ?>"><?= $contractor->name; ?></a></td>
							<? } ?>
							<? } ?>
							...
							<td class="actions">
								<?php echo anchor('admin/chancellery/items/edit/' . $item->id, lang('global:edit'), array('class'=>'button edit')); ?>
                                                                <?php echo anchor('admin/chancellery/items/delete/' . $item->id, lang('global:delete'), array('class'=>'button delete')); ?>
							</td>
							</tr>
					<?php endforeach; ?>
				</tbody>
