...
class Chancellery extends Public_Controller
{
    ...
    public function form()
    {
        ...
        if ((!isset($code[0]->code) && $settings[0]->sap_codes == 1) || !isset($limit[0]->limit)) {
            ...
            if (!isset($code[0]->code) and $settings[0]->sap_codes == 1) {
    ...
    public function order()
    {
        ...
        if ($allprice > $max_sum) {
            $this->session->set_flashdata('error',
                "You limit is $max_sum, but you order is $allprice. Please call to the support service 812-991-03-13");
